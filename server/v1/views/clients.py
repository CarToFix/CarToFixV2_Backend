...
async def create_client(client_request: CreateClient):
    ...
    cdict = client.to_dict({'show': ['name', 'phone_number', 'mail', 'id']})

    # Add the client dictionary to the message dictionary
    return {"message": "Client was created successfully!"} | cdict
